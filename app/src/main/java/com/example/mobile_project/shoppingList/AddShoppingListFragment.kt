...
import com.example.mobile_project.databinding.FragmentAddShoppingListBinding
...
class AddShoppingListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentAddShoppingListBinding = DataBindingUtil.inflate(inflater,
            R.layout.fragment_add_shopping_list, container, false)
        ...
        binding.saveListButton.setOnClickListener {
            if(binding.listNameEditText.text.isEmpty()){
                ...
                binding.shoppingListViewModel!!.addList(binding.listNameEditText.text.toString())
                Navigation.findNavController(view!!).navigate(
                    AddShoppingListFragmentDirections.actionAddShoppingListFragmentToShoppingListFragment())
            }
